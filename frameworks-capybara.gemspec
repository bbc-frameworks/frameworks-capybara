...
Gem::Specification.new do |s|
  ...
  s.authors = ["mcrmfc"]
  s.date = "2011-09-11"
  s.description = "gem to aid setup of Capybara for testing bbc sites"
  ...
  s.homepage = "http://github.com/mcrmfc/frameworks-capybara"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.10"
  s.summary = "gem to aid setup of Capybara for testing bbc sites"
  s.test_files = [
    "test/helper.rb",
    "test/test_frameworks-capybara.rb"
  ]
